---
audio_file: 008-normes-fantasma-casa-entitats.mp3
date: '2026-01-15'
...
season: 1
sources:
- title: "Reglament d'ús de locals municipals a Tiana"
  url: "https://tiana.cat/wp-content/uploads/2024/05/20240509_Resolucio_Reglament_Reglament-DIOPTRIA-definitiu.pdf"
  description: "Reglament oficial aprovat pel ple municipal que regula l'ús de l'espai dioptria (disponible des del web del dioptria)"
- title: "Tramit per solicitar sales"
  url: "https://tiana.cat/peticio-sales-material-municipal/"  
  description: "Tramit per demanar sales, equipaments, ocupació de via pública, materials, contenidors i indicar horaris i quina afectació de mobilitat hi ha amb només una gestió"
- title: "Document a omplir per reservar sala amb el reglament"
  url: "https://tiana.cat/wp-content/uploads/2023/02/FORMULARI-COMUNICACIO-RETOCAT_MARCA.pdf"  
  description: "Comunicació espectacle aforament reduït: Les entitats, associacions, formacions polítiques i col·lectius, poden sol·licitar l’autorització d’espais en equipaments per fer-hi reunions, cursets, activitats formatives, seus socials, exposicions, tallers, activitats de lleurei d’altres. També poden demanar els espais públics a l’aire lliure per fer espectacles i activitats. Les sol·licituds es poden fer per espais dels següents equipaments: Sala Albéniz, Sala d’Exposicions, Sala St. Jordi, Parcs, jardins i places públiques. Les sol·licituds s’han de fer arribar amb una antelació mínima de 30 dies"
- title: "Agenda Cultural de Tiana"
  url: "https://tiana.cat/agenda-cultural/"
  description: "Informació sobre l'ús dels equipaments culturals del municipi"
- title: "Servei Diòptria"
  url: "https://tiana.cat/dioptria/"
  description: "Informació sobre el servei de gestió d'equipaments juvenils i culturals"
- title: "Diòptria - 1 any de balanç"
  url: "https://tiana.cat/dioptria-1-any-balanc/"
  description: "Balanç del primer any de funcionament del servei Diòptria"
- title: "Cal Frares - Equipament cultural"
  url: "https://tiana.cat/equipaments/cals-frares/"
  description: "Informació sobre l'equipament municipal Cal Frares"
- title: "Espai Jove de Tiana"
  url: "https://tiana.cat/joventut/espai-jove/"
  description: "Informació sobre l'espai jove i els seus horaris i activitats"
- title: "Instància de petició d'informació - Associació Veïnal Can Gaietà"
  url: "/podcast/sources/008-instancia-informacio-reserva-dioptria.pdf"
  description: "Document oficial: Instància presentada per l'Associació Veïnal Can Gaietà exigint transparència sobre les normes d'ús de l'Espai Diòptria. Detalla les contradiccions entre el reglament oficial i les restriccions horàries aplicades, i sol·licita dades d'ús real de l'equipament."
...
- **Una petició simple que es complica**: L'Associació Veïnal de Can Gaietà demana la sala per fer la seva assemblea a les 18:45h, però l'Ajuntament els diu que només poden a partir de les 20:30h. Per què?

- **Normes fantasma**: La restricció horària que justifica la denegació no apareix a cap reglament oficial, ni a la web municipal, ni enlloc. És una "norma" que només existeix en el correu de denegació.

- **Contradicció flagrant**: El Reglament aprovat pel Ple diu que les entitats tenen "preferència d'ús". Però el servei Diòptria aplica el contrari: "els joves tenen preferència d'ús" de 17h a 20:30h.

- **Caos administratiu total**: El calendari online no funciona, el formulari oficial no inclou l'espai, ningú sap quin procediment seguir. És un embolic que dificulta la participació ciutadana.

- **L'argument del "bon clima"**: Es justifica la restricció per no "condicionar el bon clima" dels joves que juguen a la Play o fan deures. Però el mateix Ajuntament organitza xerrades i tallers en el mateix horari.

- **Discriminació horària**: L'horari imposat (20:30h) fa pràcticament impossible que participin famílies amb nens petits, gent gran o persones que treballen i es lleven d'hora.

- **Fiscalització ciutadana**: L'associació presenta una instància formal emprant la Llei de Transparència per exigir que l'Ajuntament mostri les dades d'ús real de la sala i el fonament jurídic de les restriccions.
...
- **Famílies amb fills petits**: Impossible participar en horari de sopars/bany/son
- **Gent gran**: Sortir de casa de nit a l'hivern és una barrera infranquejable
- **Treballadors amb horaris matinals**: Reunions que acaben després de les 22h són impracticables
