...
description: "La contraportada de la revista municipal Plaça de la Vila dedica una
  ...
  YouTube als 12 anys. Sense cap context mèdic, sense cap advertència sobre riscos.
  En el mateix moment, Austràlia prohibeix les xarxes per a menors de 16, França les
  restringeix per sota dels 15 i Espanya tramita una llei en la mateixa línia. L'oposició
...
- title: "Videoacta del Ple Municipal del 3 de març de 2026"
  ...
  description: "Enregistrament complet de la sessió plenària on l'oposició critica
    la contraportada de la revista i es denuncia censura i desigualtat de tracte"
...
- title: "Revista municipal Plaça de la Vila (gener-febrer 2026)"
  url: "https://tiana.cat/ajuntament/comunicacio/placa-de-la-vila/"
  description: "Número de la revista municipal amb la contraportada analitzada:
    reportatge sobre un jove youtuber de Tiana sense cap context mèdic ni advertències"
- title: "Carta d'Aixeca el Cap sobre la Revista"
  url: "/podcast/sources/013-carta-aixeca-el-cap.txt"
  description: "Comunicat de l'associació de famílies Aixeca el Cap denunciant la
    irresponsabilitat institucional de la contraportada"
- title: "Correspondència COMB — Escola Lola Anglada de Tiana (febrer 2026)"
  url: "/podcast/sources/013-comb-carta-escola-lola-anglada.pdf"
  description: "Carta de la Dra. Berta Areny Perelló, Vicesecretària del Col·legi
    de Metges de Barcelona, amb recomanacions específiques per a l'escola de Tiana:
    els mòbils no haurien d'estar disponibles ni a la motxilla durant l'horari escolar"
- title: "Informe: Per què la contraportada de la revista és una irresponsabilitat institucional"
  url: "/podcast/sources/013-informe-youtuber-revista-pantalles.md"
  description: "Document de treball (març 2026) amb 35 referències científiques i
    legislatives que argumenten punt per punt els riscos de la contraportada"
- title: "Austràlia: Social media platforms removed 4.7 million accounts (PBS News, gener 2026)"
  url: "https://www.pbs.org/newshour/world/social-media-platforms-removed-4-7-million-accounts"
  description: "Les plataformes van eliminar 4,7 milions de comptes de menors de 16
    anys a Austràlia en les primeres setmanes d'aplicació de la llei"
- title: "Espanya, França i Austràlia: les lleis de prohibició per a menors (TIME, febrer 2026)"
  url: "https://time.com/7368633/spain-social-media-ban-under-16-sanchez-australia-france/"
  description: "Resum de les iniciatives legislatives globals per prohibir l'accés
    de menors a xarxes socials"
- title: "Col·legi de Metges de Barcelona: Estudi sobre pantalles en infants i adolescents (gener 2024)"
  url: "https://www.comb.cat/pdf/publicacions/estudi-pantalles-CA.pdf"
  description: "Informe de referència del COMB sobre els efectes de les pantalles
    en la salut dels menors. Base de les recomanacions als centres educatius de Tiana"
- title: "AEP: Efectes dels mitjans digitals en la salut física i mental dels menors (juny 2025)"
  url: "https://www.analesdepediatria.org/es-efectos-medios-digitales-salud-fisica-articulo-S1695403325001110"
  description: "Document de referència dels pediatres espanyols amb recomanacions
    actuals sobre efectes digitals en menors. Lliga la sobreestimulació a trastorns
    d'atenció, son i ansietat"
- title: "Surgeon General dels EUA demana etiquetes d'advertiment com al tabac (APHA, juliol 2024)"
  url: "https://www.apha.org/publications/public-health-newswire/articles/2024/07/05/social-media-dangers"
  description: "El màxim responsable de salut pública dels EUA declara les xarxes
    socials una emergència de salut pública. Adolescents amb >3h/dia a xarxes dupliquen
    el risc de depressió"
- title: "Estadístiques YouTube: només el 0,5% dels canals arriben a 100.000 subscriptors (Thunderbit, novembre 2025)"
  url: "https://thunderbit.com/blog/fifty-youtube-key-statistics"
  description: "De 114 milions de canals a YouTube, menys del 0,5% arriben als
    100.000 subscriptors. El 88% dels vídeos no arriben a 1.000 visualitzacions"
- title: "Llei francesa de protecció de menors influencers (Library of Congress, octubre 2020)"
  url: "https://www.loc.gov/item/global-legal-monitor/2020-10-30/france-parliament-adopts-law-to-protect-child-influencers-on-social-media/"
  description: "França va legislar el 2020 que els menors creadors de contingut amb
    ànim de lucre necessiten autorització governamental. Sancions: fins a 5 anys de
    presó i 75.000€"
- title: "El 62% de les famílies catalanes no volen mòbil per als fills fins als 16 anys (Social.cat, abril 2024)"
  url: "https://www.social.cat/noticia/20935/62-families-no-volen-mobil-fills-fins-16-anys-pero-82-reconeix"
  description: "Enquesta d'ALM a 22.919 famílies catalanes: el 61,7% de famílies
    de primària voldrien esperar als 16, però el 82,1% de famílies de secundària
    reconeixen haver-lo donat als 12 o abans"
